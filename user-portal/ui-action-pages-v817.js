...
function open(button,info){
 ...
 const confirmLabel=mode==='approval'?'提交审核结论':mode==='api'?'保存密钥配置':mode==='candidate'?'加入候选片单':mode==='ingest'?'提交入库并开始上传':mode==='remove'?'确认移出':'确认操作';
