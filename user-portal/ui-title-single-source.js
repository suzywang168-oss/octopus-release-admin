...
#${FLOAT}{display:none!important;visibility:hidden!important;width:0!important;min-width:0!important;max-width:0!important;height:0!important;margin:0!important;padding:0!important;overflow:hidden!important;pointer-events:none!important}
/* With the floating title gone, toolbar contains search/actions only. */
.ota-toolbar{display:flex!important;align-items:center!important;justify-content:flex-end!important;gap:10px!important;width:100%!important;max-width:none!important;min-width:0!important;margin:0!important;transform:none!important;position:relative!important;inset:auto!important}
.ota-toolbar>input,.ota-toolbar>.ota-search-host{order:1!important;flex:1 1 420px!important;width:min(520px,46vw)!important;min-width:260px!important;max-width:520px!important;margin-left:auto!important}
.ota-toolbar>#octopusGlobalActionHost{order:2!important;flex:0 0 auto!important}.ota-toolbar>.ota-actions{order:3!important;flex:0 0 auto!important;margin-left:0!important}
...
@media(max-width:860px){.ota-toolbar{flex-wrap:wrap!important}.ota-toolbar>input,.ota-toolbar>.ota-search-host{flex:1 1 100%!important;width:100%!important;max-width:none!important;min-width:0!important}.ota-toolbar>.ota-actions{margin-left:auto!important}}
`}
}
function findFixed(){
...
window.OctopusTitleSingleSource={apply:write,meta:META,version:'6.0'};
})();